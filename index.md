...
- **Site impact indicator** with
  ...
  effectively.
- **Regional impact indicator** with
...
and (2) Environmental Impact Classification for Alien Taxa (EICAT) data
...
![](reference/figures/README-species_indicator-1.png)
...
![](reference/figures/README-site_indicator-1.png)
...
argument allows the function
[`compute_regional_indicator()`](https://b-cubed-eu.github.io/impIndicator/reference/compute_regional_indicator.md)
to calculate the confidence interval of the regional impact indicator
...
![](reference/figures/README-regional_indicator-1.png)
...
![](reference/figures/README-RMSE_sensitivity-1.png)
...
![](reference/figures/README-Error_sensitivity-1.png)
